    ...
    <div className="flex flex-col min-h-[100dvh] bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-50">
      <header className="px-6 lg:px-14 h-20 flex items-center border-b border-slate-200 dark:border-white/10 bg-white/50 dark:bg-slate-950/50 backdrop-blur-md sticky top-0 z-50">
        ...
        <nav className="ml-auto flex gap-4 sm:gap-6 items-center">
          ...
          <ThemeToggle />
          <Link href="/login">
            <Button variant="outline" className="border-rose-500/50 text-rose-500 dark:text-rose-400 hover:bg-rose-500/10">
              Giriş Yap
            </Button>
          </Link>
        </nav>
        ...
        <section id="features" className="w-full py-12 md:py-24 lg:py-32 bg-white dark:bg-slate-900/50 border-y border-slate-200 dark:border-white/5">
          <div className="container px-4 md:px-6 mx-auto">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3">
              <div className="group relative overflow-hidden rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 hover:border-rose-500/50 dark:hover:border-rose-500/50 shadow-sm dark:shadow-none transition-all duration-300">
                <div className="absolute inset-0 bg-gradient-to-b from-rose-500/5 to-transparent dark:from-rose-500/10 opacity-0 group-hover:opacity-100 transition-opacity" />
              ...
              <div className="group relative overflow-hidden rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 hover:border-blue-500/50 dark:hover:border-blue-500/50 shadow-sm dark:shadow-none transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Yapay Zeka Risk Analizi</h3>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              ...
              <div className="group relative overflow-hidden rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 hover:border-amber-500/50 dark:hover:border-amber-500/50 shadow-sm dark:shadow-none transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">48 Saat Şeffaflık Kuralı</h3>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
